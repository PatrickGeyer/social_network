			...
			<table cellspacing='0'>
				<tr>
					<td style='margin-right:5px;'>
						<div id='a' filter_id = 'p' class="feed_selector group_feed_selector <?php if($feed_id == 'p'){echo 'active_feed';}?>">Posts</div>
					</td>
					<td>
						<div id='s' filter_id = 'f' class="feed_selector group_feed_selector <?php if($feed_id == 'f'){echo 'active_feed';}?>">Files</div>
					</td>
				</tr>
			</table>
		</div>
