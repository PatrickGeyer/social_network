    ...
    <div id="friends_bar" class="friends_bar" style='overflow-x:hidden;width:100%;height:100%;'>
        <div id="friend_load">
            <div id="group_list">
                <ul style="width:100%;">
                    ...
                    foreach ($groups as $group_id) {
                        $valid2 = "";
                        $query_group = "SELECT id, name, about FROM `group` WHERE id = :group_id;";
                ...
                <ul style="width:100%;">
                    ...
                    foreach ($groups as $group_id) {
                        ...
                        while ($friends_in_group = $friend_query->fetch(PDO::FETCH_ASSOC)) {
                            $friend_group_query = "SELECT id, name, position FROM user WHERE id = :member_id;";
            ...
            <div id="school_list">
                <ul style="width:100%;">
                    <?php
                    $query = "SELECT id, name, position FROM user WHERE community_id = :user_school_id AND position != :user_position;";
                    $query = $database_connection->prepare($query, array(PDO::ATTR_CURSOR => PDO::CURSOR_FWDONLY));
