...
<body>
    ...
    ?>
    <div class="container">
        <div class='box_container box_container_nav' style='float: left;width:300px;margin-left:30px;margin-top:23px;'>
        ...
        <div class='box_container' style='float: right; width:430px;margin-top:23px;'>
            <?php if($current_tab == "profile") : ?>
            <h3>Public Profile</h3>
            <ul>
                <li class='section'>
                    <label class='settings'>Email</label>
                    <input type="text" placeholder="Email..."autocomplete="off" name="newemail" value="<?php
                    if ($user->getEmail() != '') {
                        echo $user->getEmail();
                    }
                    ?>"/>                        
    ...
    ELSE!!!
<?php endif; ?>
<button class='pure-button-success small' style='float:right;'>Update</button>
</div>
</div>
</body>